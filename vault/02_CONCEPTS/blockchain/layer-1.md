...
Bitcoin、Ethereum、TRON、Hyperliquid L1。
...
- **2026-08-27** — 语义关联层判断 (AI seed, 待人工复核): 前置 = blockchain; typed 关系 2 条。词表见 [[relationship-types|关系类型受控词表]]。
