...
- Q: 不看笔记, 用两三句话向一个聪明的外行解释 On-chain。
  A: 见上文定义。
...
- **2026-08-27** — 语义关联层判断 (Claude seed, 待 Irene 复核): 前置 = blockchain; typed 关系 0 条。词表见 [[relationship-types|关系类型受控词表]]。
