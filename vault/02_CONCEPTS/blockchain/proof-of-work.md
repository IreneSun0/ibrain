...
Proof of Work。通过计算成本竞争出块，并用经济/能源成本保护账本。
...
- **2026-08-27** — 语义关联层判断 (Claude seed, 待 Irene 复核): 前置 = consensus; typed 关系 1 条。词表见 [[relationship-types|关系类型受控词表]]。
