...
**它是目前最值得盯的一条线索**：2026-06 有报道点名 DRW 在 [[polymarket]] 与 [[kalshi]] 建立专门的做市台（报道级，具体做市协议 UNKNOWN）。**这是第一家被公开指认进入事件市场的顶级传统自营机构。**
...
**但要注意报道的边界**：公开信息是"建了台"，**具体做市协议、返佣安排、是否有做市义务全部 UNKNOWN**。有台不等于有承诺 —— 无义务的做市台可以在任何时刻撤出。
