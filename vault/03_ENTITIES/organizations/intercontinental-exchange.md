...
2025–2026 年，ICE 对 [[polymarket]] 的投资承诺至多 **$2B**（约 $8–9B 估值，2026-03 完成 $600M 一笔）；另有单一来源称其以约 $25B 估值投资 [[okx]]，引用前需复核。

ICE 的核心业务包括清算与数据，其投资方向显示其将事件市场视为基础设施资产。
...
它的进入对这个市场有两个结构性影响：
- **机构信号** —— 受监管上市公司的投资可能影响其他机构对合规与准入的评估（见 [[regulatory-access]]）。
