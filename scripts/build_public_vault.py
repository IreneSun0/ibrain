...
every decision is reported at the end of the run.
...
AUTHOR_VOICE = (
    r"每题自评", r"记入当日日志",
    # operating rules must name a role, not a person, and personal sign-off gates
    # ("needs X's approval", "clear it with X first") are not public-repo material
